...
function Enable_Disable_Account(props) {
    ...
    const approve_ben = (data) => {
        console.log(data)
        props.Enabled_Disabled_Customer(data)
            ...
            <Container className='mt-3'>
                <Row>
                    <Col lg={12} className='text-center'>
                        ...
                        <Link to="/StaffDashborad">
                            <Button variant="contained" style={{ marginLeft: "10px", width: "22%", margin: "1%", backgroundColor: "#01065D" }} > Enable/Block Customer</Button>
                        </Link>
                    </Col>
                </Row>
                {/* <Row>
                ...
                <Row>
                    <Col lg={12}>
                        ...
                        <Table bordered hover size="lg" style={{ margin: "20px", width: "90%", textAlign: "center" }}>
                            <thead>
                                <tr>
                                    <th colSpan={6} style={{ fontSize: "28px" }}>Enable - Disabled Customer</th>
                                </tr>
                                <tr>
                                    <th>S.NO</th>
                                    <th>Customer Name</th>
...
const mapDispatchToProps = (dispatch) => ({
    Enabled_Disabled_Customer: (data) => dispatch(Enabled_Disabled_Customer(data)),


})


export default connect(mapStateToProps, mapDispatchToProps)(Enable_Disable_Account);