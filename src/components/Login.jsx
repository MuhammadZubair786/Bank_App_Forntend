...
function Login(props) {
    ...
    const EmailPassword = (state, email, password) => {
        for (var i = 0; i < state.user.length; i++) {
            if (state.user[i]["email"] == email && state.user[i]["password"] == password) {
                return state.user[i]
            }
        }
        return "Not Found"
                    ...
                    <Col lg={5} style={{ border: "1px solid #020431", borderRadius: "10%", padding: "2%", marginTop: "50" }}>
                        ...
                        <div style={{ height: "20" }}>
                            ...
                            <Form.Group className="mb-3" controlId="formBasicPassword">
                                ...
                                <TextField value={password} onChange={(e) => setpassword(e.target.value)} id="outlined-basic" label="Password" variant="outlined" className='form-control' />
                            </Form.Group>
                            <br />
                            ...
                            <br />
                            <Button onClick={() => login_user()} style={{ backgroundColor: "#040B87", height: "50px" }} type="submit" className='form-control' >
                                Login
                            </Button>
